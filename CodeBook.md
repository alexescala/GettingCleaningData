...
* The set of variables which were kept were: mean() and std() for each of the signals.
* The activity of each measurement is given as the name of the name of the activity instead of the index of the activity and a separate file with a list of activities.
* The names of the variables have been slightly renamed to adhere to the rules of a tidy dataset.
* The value that appears in the dataset is the average over the variables for a given participant and activity.
